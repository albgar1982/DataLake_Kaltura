      ...
      val rows = data
        ...
        .map { row =>
          val values = row
            ...
            .map {
              case (v, DataTypes.IntegerType) => v.asInstanceOf[Int]
              case (v, DataTypes.DoubleType) => v.asInstanceOf[Double]
              case (v, DataTypes.LongType) => v.asInstanceOf[Long]
              case (v, DataTypes.BooleanType) => v.asInstanceOf[Boolean]
