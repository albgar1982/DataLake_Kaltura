...
object SubscriptionEventsUDF {
  ...
  private val eventStructType: ArrayType = ArrayType(
    new StructType()
      ...
      .add("notification_date", StringType)
  )

  val eventUDF: UserDefinedFunction = udf(
    (trialPeriod: String, startAt: String, endAt: String, productType: String, subscriptionId: String, householdType: String, addon: String, notification_date: String) =>
      process(trialPeriod, startAt, endAt, productType, subscriptionId, householdType, addon, notification_date), eventStructType)

  private def process(trialPeriod: String, startAt: String, endAt: String, productType: String, subscriptionId: String, householdType: String, addon: String, notification_date: String): ArrayBuffer[Event] = {
